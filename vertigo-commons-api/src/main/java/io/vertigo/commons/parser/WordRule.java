...
public final class WordRule implements Rule<String> {
	 ...
	 */
	WordRule(final boolean emptyAccepted, final String checkedChars, final Mode mode) {
	 ...
	 */
	WordRule(final boolean emptyAccepted, final String checkedChars, final Mode mode, final String readableCheckedChar) {
		super();
