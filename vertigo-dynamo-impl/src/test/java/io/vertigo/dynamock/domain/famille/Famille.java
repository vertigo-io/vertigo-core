...
public final class Famille implements DtObject {
	...
	public final DtList<Car> getVoituresFamilleList() {
		...
		if (voituresFamille == null) {
			voituresFamille = io.vertigo.core.Home.getApp().getComponentSpace().resolve(StoreManager.class).getDataStore().getList(fkDtListURI);
		}
	...
	public final DtList<Car> getVoituresLocationList() {
		...
		if (voituresLocation == null) {
			voituresLocation = io.vertigo.core.Home.getApp().getComponentSpace().resolve(StoreManager.class).getDataStore().getList(fkDtListURI);
		}
