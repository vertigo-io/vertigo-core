 ...
 */
public final class FileInfoFs extends AbstractFileInfo {
	/** SerialVersionUID. */
	 ...
	 */
	public FileInfoFs(final VFile vFile) {
		super(FileInfoDefinition.findFileInfoDefinition(FileInfoFs.class), vFile);
	}
}
