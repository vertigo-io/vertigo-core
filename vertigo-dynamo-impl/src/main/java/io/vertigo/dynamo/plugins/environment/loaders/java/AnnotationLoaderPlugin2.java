 ...
 * @author pchretien
 */
public final class AnnotationLoaderPlugin2 implements LoaderPlugin {
	 ...
	 */
	private static Collection<Class> getClasses(final String packageName) {
		return new Selector()
				.from(packageName)
	...
	public void load(final String resourcePath, final DynamicDefinitionRepository dynamicModelrepository) {
		...
		for (final Class<?> javaClass : getClasses(resourcePath)) {
	...
	private static void parseFragment(final Class<?> clazz, final String fragmentOf, final String dtDefinitionName, final String packageName,
	...
	private static void parseDtDefinition(final Class<?> clazz, final DtStereotype stereotype, final String dtDefinitionName, final String packageName,
			final DynamicDefinitionRepository dynamicModelRepository) {
