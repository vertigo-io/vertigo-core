...
public final class JpaStorePlugin implements StorePlugin {
	 ...
	 */
	@Inject
	public JpaStorePlugin(final KTransactionManager transactionManager, final DataBaseManager dataBaseManager, final WorkManager workManager, final AnalyticsManager analyticsManager) {
		//super(workManager);
