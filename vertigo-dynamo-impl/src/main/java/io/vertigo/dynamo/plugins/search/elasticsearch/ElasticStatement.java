 ...
 */
final class ElasticStatement<I extends DtObject, R extends DtObject> {
	private final String indexName;
	private final Client esClient;
	private final ElasticDocumentCodec elasticSearchDocumentCodec;
	 ...
	 */
	ElasticStatement(final ElasticDocumentCodec solrDocumentCodec, final String indexName, final Client esClient, final IndexFieldNameResolver indexFieldNameResolver) {
	...
	private SearchRequestBuilder createSearchRequestBuilder(final SearchQuery searchQuery, final FacetedQuery filtersQuery, final int rowsPerQuery) {
		final SearchRequestBuilder searchRequestBuilder = esClient.prepareSearch(indexName)//
				...
				.addFields(ElasticDocumentCodec.FULL_RESULT) //
