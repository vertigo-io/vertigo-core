 ...
 * @author npiedeloup
 */
public final class ExportDtParameters {
	/**
	...
	public ExportDtParameters(final String title, final List<ExportField> exportFields, final DtObject dto, final DtList dtc) {
