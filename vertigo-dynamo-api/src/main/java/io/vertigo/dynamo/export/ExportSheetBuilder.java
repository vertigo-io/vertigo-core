...
public interface ExportSheetBuilder extends  Builder<ExportSheet> {
	 ...
	 */
	ExportSheetBuilder withField(final DtField exportfield);
	 ...
	 */
	ExportSheetBuilder withField(final DtField exportfield, final MessageText label);
	 ...
	 */
	ExportSheetBuilder withField(final DtField exportfield, final DtList<?> list, final DtField displayfield);
	 ...
	 * @param label nom spécifique à utiliser dans l'export, null si l'on souhaite utiliser celui indiqué dans le DT pour ce champs
	 */
	ExportSheetBuilder withField(final DtField exportfield, final DtList<?> list, final DtField displayfield, final MessageText label);
