...
public abstract class Criteria<E extends Entity> implements Serializable {
	...
	abstract String toHql(final CriteriaCtx ctx);
	...
	public Tuples.Tuple2<String, CriteriaCtx> toHql() {
		final CriteriaCtx ctx = new CriteriaCtx();
		final String hql = this.toHql(ctx);
		return new Tuples.Tuple2<>(hql, ctx);
