...
@SuiteClasses({
		//--collections
		CollectionsManagerLucene_4_10Test.class,
		FacetManagerLucene_4_10Test.class,

		//--search
		SearchManagerDynaFieldsElasticSearch1_7Test.class,
		SearchManagerMultiIndexElasticSearch1_7Test.class,
		SearchManagerElasticSearch1_7Test.class,
		SearchManagerStoreElasticSearch1_7Test.class,
})
