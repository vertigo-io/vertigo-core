<#--
/*
 * $Id: datepicker-close.ftl,v 1.2 2014/01/15 15:32:30 npiedeloup Exp $
 */
-->
...
jQuery(document).ready(function () {
	...
	options_${escapedOptionId?html}.autoSize = true;
	options_${escapedOptionId?html}.constrainInput = false;
