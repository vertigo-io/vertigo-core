...
Running 4.4.0 - only for LTS 
----------------------
[Migration help](https://github.com/vertigo-io/vertigo/wiki/Vertigo-Migration-Guide#from-431-to-440)
...
- [Core] analytics plugin sleep only for retry
- [Core] Update libs
    - gson 2.12.1 -> 2.13.1
