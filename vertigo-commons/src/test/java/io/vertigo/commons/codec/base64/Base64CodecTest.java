...
public final class Base64CodecTest extends AbstractCodecTest<byte[], String> {
	/** 
	 * "Les sanglots longs des .." encod� en base64.
	 */
	 ...
	 * Ces 3 bytes se diff�rencient entre autre par le r�sultat de leur division modulo 3
	 */
	...
	/**
	 * Expression r�guli�re v�rifi�e par les base 64. 
	 */
	...
	protected void checkEncodedValue(final String encodedValue) {
		//On v�rifie que la valeur encod�e respecte bien le pattern.
