 ...
 * @author npiedeloup
 * @version $Id: MethodUtil.java,v 1.2 2013/11/15 17:14:36 npiedeloup Exp $
 */
public final class RestfulServicesUtil {
	...
	public static Object invoke(final Object instance, final String methodName, final Request request) {
		...
		if (actionMethod.isEmpty()) {
			throw new VRuntimeException("Méthode " + methodName + " non trouvée sur " + instance.getClass().getName());
		}
