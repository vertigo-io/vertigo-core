...
public final class TestIdentities implements AccountLoader, GroupLoader {
	...
	public void initData() {
		...
		final UID<AccountGroup> group1Uri = DtObjectUtil.createURI(AccountGroup.class, testAccountGroup1.getId());
		...
		final UID<AccountGroup> groupAllUri = DtObjectUtil.createURI(AccountGroup.class, groupAll.getId());
		saveGroup(groupAll);
