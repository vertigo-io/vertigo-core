...
final class CreateTestDataBase {
	...
	private static List<String> getCreateUserCredentialRequests() {
		return new ListBuilder<String>()
				...
				.add("insert into USER_CREDENTIAL(UCR_ID, LOGIN, PASSWORD, MAIL) values (0, 'jdoe', '', 'john.doe@yopmail.com')")
				.add("insert into USER_CREDENTIAL(UCR_ID, LOGIN, PASSWORD, MAIL) values (1, 'pluckey', '', 'palmer.luckey@yopmail.com')")
				.add("insert into USER_CREDENTIAL(UCR_ID, LOGIN, PASSWORD, MAIL) values (2, 'bclinton', '', 'bill.clinton@yopmail.com')")
				.add("insert into USER_CREDENTIAL(UCR_ID, LOGIN, PASSWORD, MAIL) values (3, 'pmormon', '', 'phil.mormon@yopmail.com')")
				.add("insert into USER_CREDENTIAL(UCR_ID, LOGIN, PASSWORD, MAIL) values (4, 'npi', '', 'npi@vertigo.io')")
				...
				.add("insert into USER_CREDENTIAL(UCR_ID, LOGIN, PASSWORD, MAIL) values (14, 'admin', '5vIy0buT0cyhh7ODeWKEv5fvaWN1mdoNE_rmkCkjvhN8u05S_Et_Q=', 'admin@yopmail.com')")
				.build();
	}
