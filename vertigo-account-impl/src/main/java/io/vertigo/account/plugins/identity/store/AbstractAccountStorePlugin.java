...
public abstract class AbstractAccountStorePlugin implements AccountStorePlugin, Activeable {
	...
	private IdentityMapperHelper<DtField, AccountProperty> mapperHelper; //AccountAttribute from UserAttribute
	...
	public final void start() {
		...
		mapperHelper = new IdentityMapperHelper(userDtDefinition, AccountProperty.class, userToAccountMappingStr)
