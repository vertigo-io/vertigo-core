...
import io.vertigo.publisher.metamodel.PublisherDataDefinition;
import io.vertigo.publisher.mock.Address;
import io.vertigo.publisher.mock.Enquete;
import io.vertigo.publisher.mock.Enqueteur;
import io.vertigo.publisher.mock.MisEnCause;
import io.vertigo.publisher.mock.PublisherMock;
import io.vertigo.publisher.mock.Ville;
import io.vertigo.publisher.model.PublisherData;
import io.vertigo.publisher.model.PublisherNode;
import io.vertigo.x.publisher.PublisherDataUtil;
...
public abstract class AbstractPublisherMergerTest extends AbstractTestCaseJU4 {
	...
	private static final String DATA_PACKAGE = "io/vertigo/publisher/data/";
